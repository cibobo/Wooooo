...
//            messageServiceBinder.startLocationMessageReceiver(mLocationClient);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationTextView = (TextView) findViewById(R.id.location_testview);
        ...
        //Create the service
        messageServiceIntent = new Intent(LocationActivity.this, MessageService.class);
    }
...
//                        mConnectionStatus.setText(R.string.no_resolution);
            ...
            default:
                ...
                Log.d(tag,"        Received an unknown activity request code " + requestCode + " in onActivityResult.");
